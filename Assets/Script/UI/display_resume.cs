...
//Ce script est lier au canvas de la scène de résumé des choix
//il va aller récuprer toute les information des choix et de réponses donnée
//précédamment dans le modèle puis il va crée des images et des texte 
//avec le titre des choix et les choix afin de les afficher pour l'utilisateur
public class display_resume : MonoBehaviour
{
	...
	void displayForme()
	{
		...
		foreach (List<Item> liste in List_of_selection)
		{
			...
			{
				temp_titre.name = "Matériaux";
				temp_text.text = "Matériaux : ";
